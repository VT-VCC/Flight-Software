...
#ifndef BOARD_COMMON_COMMON_UART_H_
#define BOARD_COMMON_COMMON_UART_H_
 ...
 * @return UART error enumeration representing the error, see docs.
 */
uart_error_t uart_write_bytes(uart_t * channel, const uint8_t * bytes,
                              size_t n);
...
#endif /* BOARD_COMMON_COMMON_UART_H_ */
