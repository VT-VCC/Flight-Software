...
#ifndef BOARD_COMMON_COMMON_SPI_H_
#define BOARD_COMMON_COMMON_SPI_H_
 ...
 * @return An error code. This should always be checked.
 */
spi_error_t spi_send_bytes(spi_t * channel, uint8_t * send_byte, size_t length);
 ...
 * @return An error code. This should always be checked.
 */
spi_error_t spi_receive_bytes(spi_t * channel, uint8_t * receive_byte,
                              size_t length);
 ...
 * @return An error code. This should always be checked.
 */
spi_error_t spi_transfer_byte(spi_t * channel, uint8_t send_byte,
 ...
 * @return An error code. This should always be checked.
 */
spi_error_t spi_transfer_bytes(spi_t * channel, uint8_t * send_bytes,
                               uint8_t * receive_bytes, size_t length);
...
#endif /* BOARD_COMMON_COMMON_SPI_H_ */
