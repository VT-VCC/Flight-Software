...
UBaseType_t x;
	...
	#if( portSTACK_GROWTH < 0 )
	{
		_Static_assert(sizeof(pxTopOfStack) == sizeof(portPOINTER_SIZE_TYPE), "Pointer size type mismatch");
		portPOINTER_SIZE_TYPE ulTopOfStack = (portPOINTER_SIZE_TYPE) pxTopOfStack;
